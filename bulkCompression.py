"""
@File       :   bulkCompression.py
@Contact    :   cmrhyq@163.com
@License    :   (C)Copyright 2022-2025, AlanHuang
@Modify Time        @Author     @Version    @Description
----------------    ----------- --------    ------------
2022/10/20 16:12     Alan Huang  0.0.1       None
"""
import os
import zipfile
...
if __name__ == '__main__':
    to_zip = input(
        """Enter the name of the folder you want to zip(N.B.: The folder name should not contain blank spaces)>""")
    to_zip = to_zip.strip() + "/"
